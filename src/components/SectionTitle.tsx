...
export const SectionTitle = ({ title, hideOnLarge = false }: SectionTitleProps) => {
  return (
    <>
      <div className="sticky top-0 z-20 -mx-10 mb-4 w-screen overflow-hidden bg-slate-900/75 px-10 py-5 backdrop-blur md:-mx-16 md:px-12 lg:sr-only lg:relative lg:top-auto lg:mx-auto lg:w-full lg:px-0 lg:py-0 lg:opacity-0">
